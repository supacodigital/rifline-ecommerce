      ...
      <div className={s.banner}>
        ...
        <div className="container">
          <h1 className={s.bannerTitle}>
            {currentCat
              ? categories.find((c) => String(c.id) === currentCat)?.name_fr ||
                t("catalogue.title")
              : t("catalogue.title")}
          </h1>
      ...
      <div className="container">
        <div className={s.layout}>
          ...
          <aside>
            ...
            <div
              className={`${s.filters} ${mobileFilterOpen ? s.mobileOpen : ""}`}
            >
              ...
              <div className={s.filterGroup}>
                ...
                {categories.map((cat) => (
                  <div
                    key={cat.id}
                    className={`${s.filterOption} ${
                      currentCat === String(cat.id) ? s.active : ""
                    }`}
